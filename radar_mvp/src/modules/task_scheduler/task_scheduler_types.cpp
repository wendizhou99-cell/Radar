...
namespace radar
{
    ...
    ScheduledTask::ScheduledTask(TaskFunction taskFunction,
    ...
    void ScheduledTask::setState(TaskState newState)
    {
        ...
        RADAR_DEBUG("Task {} state changed from {} to {}",
                    taskId_, static_cast<int>(oldState), static_cast<int>(newState));
