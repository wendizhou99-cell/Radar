...
namespace radar
{
    ...
    namespace TaskSchedulerFactory
    {
        ...
        std::unique_ptr<ThreadPoolScheduler> createThreadPoolScheduler(
        ...
        std::unique_ptr<RealTimeScheduler> createRealTimeScheduler(
            const TaskSchedulerConfig &config,
            std::shared_ptr<spdlog::logger> logger)
        {
            try
        ...
        std::unique_ptr<TaskScheduler> createScheduler(
