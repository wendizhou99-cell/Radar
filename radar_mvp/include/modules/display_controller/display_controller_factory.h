...
namespace radar
{
    namespace modules
    {
        ...
        public:
             ...
             * @brief 创建函数类型定义
             */
            using CreateFunction = std::function<std::unique_ptr<DisplayControllerBase>(
                const DisplayControllerConfig &)>;
             ...
             * @return 控制器实例或错误
             */
            std::pair<std::unique_ptr<DisplayControllerBase>, ErrorCode>
            createController(const DisplayControllerConfig &config);
             ...
             */
            std::pair<std::unique_ptr<DisplayControllerBase>, ErrorCode>
            createController(DisplayControllerType type, const std::string &name = "default");
             ...
             * @return 操作结果错误码
             */
            ErrorCode registerCreateFunction(DisplayControllerType type,
        ...
        private:
             ...
             * @return 控制器实例
             */
            static std::unique_ptr<DisplayControllerBase>
            createConsoleController(const DisplayControllerConfig &config);
             ...
             */
            static std::unique_ptr<DisplayControllerBase>
            createFileController(const DisplayControllerConfig &config);
             ...
             */
            static std::unique_ptr<DisplayControllerBase>
            createNetworkController(const DisplayControllerConfig &config);
             ...
             */
            static std::unique_ptr<DisplayControllerBase>
            createHybridController(const DisplayControllerConfig &config);
         ...
         */
        std::pair<std::unique_ptr<DisplayControllerBase>, ErrorCode>
        createConsoleDisplayController(bool coloredOutput = true, uint32_t maxLines = 100);
         ...
         */
        std::pair<std::unique_ptr<DisplayControllerBase>, ErrorCode>
        createFileDisplayController(const std::string &outputDirectory = "./output",
                                    const std::string &filePrefix = "radar_display",
                                    uint64_t maxFileSize = 10 * 1024 * 1024);
         ...
         */
        std::pair<std::unique_ptr<DisplayControllerBase>, ErrorCode>
        createNetworkDisplayController(const std::string &serverAddress = "0.0.0.0",
                                       uint16_t serverPort = 8080,
                                       uint32_t maxClients = 10);
         ...
         */
        std::pair<std::unique_ptr<DisplayControllerBase>, ErrorCode>
        createHybridDisplayController(const std::vector<DisplayControllerType> &subTypes);
