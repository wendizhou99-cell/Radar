...
class ConsoleDisplayController : public DisplayControllerBase {
  ...
  protected:
    ...
    ErrorCode saveDisplayToFile(const std::string &filePath, const DisplayData &data) override;
...
class HybridDisplayController : public DisplayControllerBase {
  public:
     ...
     * @return 操作结果错误码
     */
    ErrorCode addSubController(std::unique_ptr<DisplayControllerBase> controller, const std::string &name);
