    ...
    namespace modules
    {
        ...
        public:
            ...
            ErrorCode displayResult(const ProcessingResult &result,
                                    radar::IDisplayController::DisplayFormat format = radar::IDisplayController::DisplayFormat::CONSOLE_TEXT) override;
            ...
            ErrorCode saveToFile(const std::string &filename,
                                 radar::IDisplayController::DisplayFormat format = radar::IDisplayController::DisplayFormat::FILE_CSV) override;
        ...
        protected:
             ...
             * @return 操作结果错误码
             */
            virtual ErrorCode saveDisplayToFile(const std::string &filePath,
             ...
             * @return 显示数据
             */
            DisplayData createDisplayData(const ProcessingResult &result,
             ...
             * @return 格式化后的字符串
             */
            std::string formatProcessingResult(const ProcessingResult &result,
                                               radar::IDisplayController::DisplayFormat format);
