...
- **Compute Stream**: 专用于执行CUDA核函数计算。它必须等待当前帧的H2D拷贝完成后才能开始。
...
| v1.0.2 | 2025-09-23 | Kelin   | 增加了相关文档的链接和说明；3.1 组件组织结构图改为纯功能分组视图，移除箭头/监控虚线；补充说明文字以统一图表语义。 |
